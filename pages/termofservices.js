...
function TermOfServices() {
  return (
    <div>
      <Head>
        <title>JAD FAST  FOOD - term of services</title>
        ...
        <div className={styles.termofServices_child}>
          <ul>
            ...
            <li>
              ...
              materials (data or programming) on ®JADFASTFOOD&#39;s site for
            ...
            <div>
              <p>
                ...
                material contained on ®JADFASTFOOD&#39;s site; remove any
                ...
                confinements and may be ended by ®JADFASTFOOD whenever deemed.
            ...
            <li>
              ...
              The materials on ®JADFASTFOOD&#39;s site are given &#39;as is&#39;. ®Natural
              ...
              rights. Further, ®JADFASTFOOD does not warrant or make any
            ...
            <li>
              ...
              In no occasion should ®JADFASTFOOD or its suppliers subject for
              ...
              materials on ®JADFASTFOOD&#39;s Internet webpage, regardless of the
              possibility that ®JADFASTFOOD or a ®JADFASTFOOD approved agent
            ...
            <li>
              ...
              :
              <br />
              The materials showing up on ®JADFASTFOOD&#39;s site could
              ...
              exact, finished, or current. ®JADFASTFOOD may roll out
              improvements to the materials contained on its site whenever
              without notification. ®JADFASTFOOD does not, then again, make
              any dedication to update the materials.
            </li>
            <li>
              <span>Links</span> : <br />
              ®JADFASTFOOD has not checked on the majority of the websites or
              ...
              connection does not infer support by ®JADFASTFOOD of the site.
              Utilization of any such connected site is at the user&#39;s own risk.
            </li>
            <li>
              <span>7. Site Terms of Use Modifications</span> : <br />
              ®JADFASTFOOD may update these terms of utilization for its
            ...
            <li>
              ...
              Any case identifying with ®JADFASTFOOD&#39;s site should be
              administered by the laws of the country of Morocco ®JADFASTFOOD
